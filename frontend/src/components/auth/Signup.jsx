    ...
    <div>
      ...
      <div className="flex items-center justify-center max-w-7xl mx-auto">
        ...
        >
          ...
          <h1 className="text-xl font-bold mb-12  text-center ">Signup</h1>
          <div className="my-2">
            <Label >Full Name</Label>
            <Input className="my-2 " type="text" value={input.fullname}  name="fullname" onChange={changeEventHandler} placeholder="Bhupesh" />
          </div>
          <div className="my-2">
            <Label>Email</Label>
          ...
          <div className="my-2">
            ...
            <Input className="my-2 "type="text" value={input.phoneNumber}  name="phoneNumber" onChange={changeEventHandler} placeholder="Phone Number" />
          </div>
          <div className="my-2">
          ...
          <div >
            ...
            <div className="flex  items-center mx-4">
                <Label className="text-md font-medium mx-4">Profile Photo</Label>
                <Input 
                accept="image/*"
                type="file"
          ...
          <span className="text-sm">Already Registered ? <Link to="/login" className="text-blue-600">LogIn</Link></span>
        </form>
      </div>
    </div>
  );
